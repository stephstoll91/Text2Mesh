...
class Batch:
    ...
    def __init__(
        ...
        # Sign
        sgn, self.sgn_lengths = torch_batch.sgn
        self.sgn = sgn # [:, :, :150]
        self.sgn_face = sgn # [:, :, 150:]
        ...
        if self.future_prediction != 0:
            ...
            self.sgn = self.sgn[:, :-self.future_prediction, :]
            self.sgn_lengths = self.sgn_lengths - self.future_prediction

        self.sgn_dim = sgn_dim # - 140
        self.sgn_dim_face = sgn_dim # - 150
        self.sgn_mask = (self.sgn != torch.zeros(self.sgn_dim))[..., 0].unsqueeze(1)
        self.sgn_mask_face = (self.sgn_face != torch.zeros(self.sgn_dim_face))[..., 0].unsqueeze(1)
    ...
    def _make_cuda(self):
        ...
        self.sgn_face = self.sgn_face.cuda()
        self.sgn_mask_face = self.sgn_mask_face.cuda()
    ...
    def sort_by_sgn_lengths(self):
        ...
        self.sgn_face = self.sgn_face[perm_index]
        self.sgn_mask_face = self.sgn_mask_face[perm_index]
